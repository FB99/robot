...
def get_bag(p6):
    ...
    print("RQ3:"+str([Rq3[0][2],Rq3[1][2],Rq3[2][2]]))
    print("RQ4:"+str([Rq4[0][2],Rq4[1][2],Rq4[2][2]]))
    result = p1-np.array([Rq3[0][2],Rq3[1][2],Rq3[2][2]])*170-np.array([Rq4[0][2],Rq4[1][2],Rq4[2][2]])*170
    #result = p1 + [-0.095,0.061521,-0.07457] * 170 +[-0.243, 0.617,-0.7481]*170
    print("actual destination point:")
    print(result)
    print("######################")
    # print(R4)
    # print(R)
...
#q1 range[-10,200] 向前角度增大   初始值40  145 = 90 degree naturall
...
if __name__ == '__main__':
    ...
    # p = np.array([200, 0, -30])
    # R = np.array([[-np.sqrt(2) / 2, -2 / 3, np.sqrt(3) / 3],
    #       [0, 1 / 3, np.sqrt(3) / 3],
    #       [np.sqrt(2) / 2, -2 / 3, np.sqrt(3) / 3]])
    # ans = cal_roll_agl(p, R)
    # print(ans)
